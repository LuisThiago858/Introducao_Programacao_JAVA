 ...
 * Enunciado
Ordem crescente
Agora você tem que fazer o inverso do exércicio anterior, ou seja, imprima os números na ordem crescente, para assim sua colega maria se livrar de uma vez por todas desses trabalhos.

Dicas
A classe deve se chamar Numero.
Sua classe deve ter somente um atributo do tipo int.
Crie um método chamado ordemCrescente(Numero num1, Numero num2), que imprime os números em ordem crescente.
